...
class Lottery:
    ...
    def __init__ (self, strfrom, server, participants, emails, full_list):
    ...
    def sendtable(self,message):
        ...
        TEXT = self.gettable.to_html(index=False)
